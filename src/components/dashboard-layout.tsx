...
const BottomNavbar = ({ navItems }: {
  ...
  return <nav className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around border-t border-muted/30 rounded-t-md bg-background/60 backdrop-blur-lg px-2 py-1">
    {navItems.map((item) => {
